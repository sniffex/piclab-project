...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://piclab-project-api.vercel.app/api/auth/login', { email, password });
            ...
            <div class="py-36 p-5">
                <div class="flex bg-white text-gray-500 border-2 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    <div class="hidden lg:block lg:w-1/2 bg-cover ">
                        <img src={login} className="rounded-l-lg h-full w-full" alt="welcome" />
                    </div>
                    <form onSubmit={handleSubmit} class="w-full p-5 lg:w-1/2 md:px-10 px-5">
                        ...
                        <div class="mt-4">
                            <div class="flex justify-between">
                                ...
                                <a href="/#" class="text-sm text-gray-600 hover:text-black hover:underline">
                                    Forget Password?
                                </a>
                            </div>
                  ...
                  <Icon className="hover:text-gray-700" icon={icon} size={22} />
                        ...
                        <div class="mt-8">
                            <button
                                type="submit"
                                class="bg-blue-700 text-white text-center font-medium py-2.5 px-5 w-full rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
                            >
                                Login
                            </button>
                        </div>
                        <div class="mt-6 flex flex-row items-center justify-center gap-2">
                            ...
                            <Link to="/signup">
                                <div className="font-bold text-blue-600 text-md">Create now</div>
                            </Link>
                        </div>
                    </form>
                </div>
